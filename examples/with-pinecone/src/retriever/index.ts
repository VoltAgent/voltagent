...
async function initializeIndex() {
  try {
    ...
    if (stats.totalRecordCount === 0) {
      console.log("📚 Populating index with sample documents...");
      ...
      if (recordsWithEmbeddings.length > 0) {
        ...
        console.log(`✅ Successfully upserted ${recordsWithEmbeddings.length} documents to index`);
      }
    } else {
      console.log(`📊 Index already contains ${stats.totalRecordCount} documents`);
    }
  } catch (error) {
