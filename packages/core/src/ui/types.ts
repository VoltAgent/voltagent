...
/**
 * A VoltAgent UIMessage for integrating with the Vercel AI SDK v4 and v5.
 */
...
> = TVersion extends "v4" ? VercelV4Message : VercelV5Message<TMetadata, TDataParts>;
 ...
 */
export type VercelV4Message = Omit<VercelAI.UIMessage, "id" | "data" | "toolInvocations"> & {
  id: string;
};
