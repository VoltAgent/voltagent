...
export function CommunitySection() {
  ...
  return (
    <section className="relative w-full overflow-hidden relative z-10">
      <GitHubStarsProvider>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 relative z-10 gap-3 md:gap-12 landing-xs:mt-12 landing-md:mt-0">
            {COMMUNITY_LINKS.map((link, index) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={`group relative landing-xs:p-6 landing-md:p-12 relative z-10  landing-md:border-solid border-white/10 no-underline transition-all flex flex-col items-center animate-fade-in landing-xs:unset landing-md:bg-black/20 rounded-lg hover:border-main-emerald hover:bg-black/40
