...
export const Console = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 landing-xs:mb-16 landing-md:mb-24">
        {/* Header Section - Original Style */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 landing-sm:gap-8 mb-24 items-center">
      ...
      <div className="h-[600px] md:h-[800px] mb-24 sm:px-6 lg:px-8 ">
        <iframe
      ...
      <div className="max-w-7xl mx-auto px-4 mb-16">
        <div className="text-left">
          <h2 className="text-2xl md:text-3xl text-emerald-500 font-bold mb-4">
            AI Agent Observability Matters
          </h2>
          <p className="text-gray-400 max-w-3xl text-base sm:text-lg  mb-4">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 landing-md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-6">
            ...
            <motion.div
              className="rounded-lg border-2 border-solid border-emerald-500/30  transition-all duration-300 overflow-hidden h-auto"
              initial={{ opacity: 0, y: 0 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
            >
              <div
                className="p-4 border-b border-white/10 bg-[#191c24]"
                style={{
                  backdropFilter: "blur(4px)",
                  WebkitBackdropFilter: "blur(4px)",
                }}
              >
                <div className="flex items-start gap-4">
                  <div className="bg-emerald-400/10 w-8 h-8 landing-md:w-10 landing-md:h-10 rounded-md flex items-center justify-center shrink-0">
                    <ListBulletIcon className="w-4 h-4 landing-md:w-5 landing-md:h-5 text-emerald-400" />
                  </div>
            ...
            >
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="bg-emerald-400/10 w-8 h-8 landing-md:w-10 landing-md:h-10 rounded-md flex items-center justify-center shrink-0">
                    <CommandLineIcon className="w-4 h-4 landing-md:w-5 landing-md:h-5 text-emerald-400" />
                  </div>
                  <div className="flex-1">
                    <div className="mb-1 landing-xs:text-sm landing-lg:text-base font-semibold text-white">
                      Agent Chat
                    ...
                    <p className="text-gray-400 landing-lg:text-sm landing-xs:text-xs mb-0 leading-relaxed">
                      {getResponsiveText(
                        ...
                        "Chat with your AI agents in real-time, with detailed metrics and insights.",
                      )}
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="bg-emerald-400/10 w-8 h-8 landing-md:w-10 landing-md:h-10 rounded-md flex items-center justify-center shrink-0">
                    <EyeIcon className="w-4 h-4 landing-md:w-5 landing-md:h-5 text-emerald-400" />
                  </div>
                  <div className="flex-1">
                    <div className="mb-1 landing-xs:text-sm landing-lg:text-base font-semibold text-white">
                    ...
                    <p className="text-gray-400 landing-lg:text-sm landing-xs:text-xs mb-0 leading-relaxed">
                      {getResponsiveText(
                        ...
                        "Detailed inputs, outputs, and parameters for agent, memory, and tool call.",
                      )}
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="bg-emerald-400/10 w-8 h-8 landing-md:w-10 landing-md:h-10 rounded-md flex items-center justify-center shrink-0">
                    <ArrowPathIcon className="w-4 h-4 landing-md:w-5 landing-md:h-5 text-emerald-400" />
                  </div>
                  <div className="flex-1">
                    <div className="mb-1 landing-xs:text-sm landing-lg:text-base font-semibold text-white">
                    ...
                    <p className="text-gray-400 landing-lg:text-sm landing-xs:text-xs mb-0 leading-relaxed">
                      {getResponsiveText(
                        ...
                        "Visualize and debug your AI agent's execution flow in real-time with.",
                      )}
                    </p>
                  </div>
                </div>
