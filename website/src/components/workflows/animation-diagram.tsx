          ...
          <div className="flex flex-col md:flex-row md:items-center items-start">
                  ...
                  <code className="py-5 px-3 block text-xs">
                    ...
                    <span
                      className={`text-purple-400 ml-2 transition-all duration-500 ease-in-out ${
                        animationStep === 2
                          ? "text-shadow-neon-purple font-bold"
                          : ""
                      }`}
                    >
                      .andAll
            ...
            <div
              className={`w-full relative ${
                isMobile ? "min-h-[400px]" : "min-h-[250px] mr-12"
              }`}
              ref={diagramRef}
            >
              <div
              ...
              >
                ...
                <div
                  ...
                  className={`absolute ${
                    ...
                    animationStep >= 2
                      ? colors.workflow.activeShadow
                      : colors.workflow.shadow
                  }`}
                >
                  <ArrowPathIcon
                ...
                <div
                  ...
                  className={`absolute ${
                    ...
                    animationStep === 3
                      ? colors.agentA.activeShadow
                      : colors.agentA.shadow
                  } bg-black/80`}
                >
                  <CpuChipIcon
                ...
                <div
                  ...
                  className={`absolute ${
                    ...
                    animationStep === 3
                      ? colors.agentB.activeShadow
                      : colors.agentB.shadow
                  } bg-black/80`}
                >
                  <CpuChipIcon
                ...
                {animationStep >= 2 && (
                  <AnimatedBeam
                    ...
                    pathWidth={1.5}
                    gradientStartColor={
                      animationStep > 2 ? "transparent" : colors.workflow.beam
                    }
                    gradientStopColor={
                      animationStep > 2 ? "transparent" : colors.workflow.beam
                    }
                ...
                {animationStep >= 3 && (
                  <AnimatedBeam
                    ...
                    pathWidth={1.5}
                    gradientStartColor={
                      animationStep > 4 ? "transparent" : colors.agentA.beam
                    }
                    gradientStopColor={
                      animationStep > 4 ? "transparent" : colors.agentA.beam
                    }
                ...
                {animationStep >= 3 && (
                  <AnimatedBeam
                    ...
                    pathWidth={1.5}
                    gradientStartColor={
                      animationStep > 4 ? "transparent" : colors.agentB.beam
                    }
                    gradientStopColor={
                      animationStep > 4 ? "transparent" : colors.agentB.beam
                    }
